      ...
      <div className="container mx-auto p-8 relative z-10">
        ...
        <Dialog open={isAnalysisModalOpen} onOpenChange={setIsAnalysisModalOpen}>
          <DialogContent className="max-w-4xl max-h-[80vh]">
            <DialogHeader>
              <DialogTitle>ElevenLabs Analysis</DialogTitle>
              <DialogDescription>
                Analysis results for the completed conversation.
              </DialogDescription>
            </DialogHeader>
            {isAnalysisLoading ? (
            ...
            <DialogFooter>
              <Button onClick={() => setIsAnalysisModalOpen(false)} disabled={isAnalysisLoading}>
                Close
              </Button>
            </DialogFooter>
          </DialogContent>
